...
public class ReviewController {
    ...
    public ResponseEntity<ApiResponse<ReviewDetailResponse>> submitReview(
        ...
        return ResponseEntity.status(HttpStatus.CREATED)
                .body(ApiResponse.success("Review submitted.", reviewCommandService.submitReview(taskId, request)));
    }
    ...
    public ResponseEntity<ApiResponse<ReviewDetailResponse>> approveReview(
        ...
        return ResponseEntity.ok(
                ApiResponse.success(
                        "Review approved.",
                        reviewCommandService.approveReview(reviewId, reviewVersion)
                )
        );
    }
    ...
    public ResponseEntity<ApiResponse<ReviewDetailResponse>> rejectReview(
        ...
        return ResponseEntity.ok(
                ApiResponse.success(
                        "Review rejected.",
                        reviewCommandService.rejectReview(reviewId, reviewVersion, request)
                )
        );
    }
    ...
    public ResponseEntity<ApiResponse<ReviewDetailResponse>> cancelReview(
        ...
        return ResponseEntity.ok(
                ApiResponse.success(
                        "Review cancelled.",
                        reviewCommandService.cancelReview(reviewId, reviewVersion, cancelRequest)
                )
        );
    }
}
