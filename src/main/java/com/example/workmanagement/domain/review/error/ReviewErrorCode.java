...
public enum ReviewErrorCode implements ErrorCode {
    ...
    ATTACHMENT_OBJECT_NOT_FOUND(HttpStatus.BAD_REQUEST, "업로드된 첨부 객체를 찾을 수 없습니다."),
    ATTACHMENT_OBJECT_METADATA_MISMATCH(HttpStatus.BAD_REQUEST, "업로드된 첨부 메타데이터가 요청과 일치하지 않습니다."),
    ATTACHMENT_STORAGE_UNAVAILABLE(HttpStatus.SERVICE_UNAVAILABLE, "첨부 스토리지가 설정되지 않았습니다."),
